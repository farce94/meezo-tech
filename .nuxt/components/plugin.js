...
const components = {
  ...
  CareersAccordion: () => import('../..\\components\\CareersAccordion.vue' /* webpackChunkName: "components/careers-accordion" */).then(c => wrapFunctional(c.default || c)),
  CareersItems: () => import('../..\\components\\CareersItems.vue' /* webpackChunkName: "components/careers-items" */).then(c => wrapFunctional(c.default || c)),
  CareersList: () => import('../..\\components\\CareersList.vue' /* webpackChunkName: "components/careers-list" */).then(c => wrapFunctional(c.default || c)),
  ...
  JobForm: () => import('../..\\components\\JobForm.vue' /* webpackChunkName: "components/job-form" */).then(c => wrapFunctional(c.default || c)),

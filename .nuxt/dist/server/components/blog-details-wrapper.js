exports.ids = [10,14,15,32,33,40,41,42,43,44];
exports.modules = {
...
//
//
/* harmony default export */ var WidgetTagsvue_type_script_lang_js_ = ({data(){return{tags:["Business","Consulting","User Interface","Corporate","Agency","Gardening","Industry","Minimal","Unique"]};}});
...
//
//
/* harmony default export */ var BlogDetailsWrappervue_type_script_lang_js_ = ({components:{PostAuthorInfo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 49)),CommentList:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 44)),CommentForm:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 45)),WidgetSearch:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 37)),ServiceCategoryWidget:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 34)),WidgetVideo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 35)),WidgetSocial:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 36)),WidgetRecentPost:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 38)),WidgetTags:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 39))}});
...
installComponents(component, {PostAuthorInfo: __webpack_require__(49).default,CommentList: __webpack_require__(44).default,CommentForm: __webpack_require__(45).default,WidgetSearch: __webpack_require__(37).default,ServiceCategoryWidget: __webpack_require__(34).default,WidgetVideo: __webpack_require__(35).default,WidgetSocial: __webpack_require__(36).default,WidgetRecentPost: __webpack_require__(38).default,WidgetTags: __webpack_require__(39).default})

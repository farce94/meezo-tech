...
//
//
/* harmony default export */ var PortfolioSectionvue_type_script_lang_js_ = ({data(){return{portfolioSliderContainer:{speed:1500,slidesPerView:'auto',centeredSlides:true,loop:true,spaceBetween:30,autoplay:{delay:2500,disableOnInteraction:false},breakpoints:{1800:{slidesPerView:'auto',spaceBetween:50},1400:{slidesPerView:3,slidesPerGroup:1,spaceBetween:30},992:{slidesPerView:3},768:{slidesPerView:2,centeredSlides:false},0:{slidesPerView:1}}}};}});

...
//
//
/* harmony default export */ var TestimonialOnevue_type_script_lang_js_ = ({data(){return{testimonialSlider:{speed:1500,slidesPerView:1,loop:true,spaceBetween:30,navigation:{nextEl:'.testimonial-slider-container .swiper-button-next',prevEl:'.testimonial-slider-container .swiper-button-prev'}},testimonials:[{name:"Reinaldo Thurman",designation:"Senior Consultant",imgSrc:"/images/icons/t1.png",desc:"It is long established fact that reader will distract by the readable content a page when looking atten layout. The point of using  and that it has a more normal distribution of letters, as opposed using making it look like readable English."},{name:"Jannat Maya",designation:"Marketing Consultant",imgSrc:"/images/icons/t1.png",desc:"Lorem ipsum dolor sit amet, marketing consultant elit eiusmod tempor incididunt labore et doloreant magna aliqua. Enim minim veniam, adritu ullamco marketing consultant normal distribution opostent using making it look like readable English."}]};}});

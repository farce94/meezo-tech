exports.ids = [53,16,19,21,24,25,26,27,29];
exports.modules = {
...
//
//
/* harmony default export */ var PortfolioDetailsWrappervue_type_script_lang_js_ = ({components:{CoolLightBox: external_vue_cool_lightbox_default.a},data(){return{items:[{src:"https://www.youtube.com/watch?v=eS9Qm4AOOBY",autoplay:true}],index:null};}});
...
//
//
/* harmony default export */ var project_detailsvue_type_script_lang_js_ = ({components:{Header:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 26)),OffCanvasMobileMenu:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 30)),PageTitle:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 31)),PortfolioDetailsWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 59)),ContactDevider:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 33)),Footer:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 25))},head(){return{title:'Project Details'};}});
...
/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(26).default,OffCanvasMobileMenu: __webpack_require__(30).default,PageTitle: __webpack_require__(31).default,PortfolioDetailsWrapper: __webpack_require__(59).default,ContactDevider: __webpack_require__(33).default,Footer: __webpack_require__(25).default})

exports.ids = [55,16,19,21,24,25,26,27,33,34,42,44];
exports.modules = {
...
//
//
/* harmony default export */ var ServiceCategoryWidgetvue_type_script_lang_js_ = ({data(){return{categories:['Business Management','Web Development','Digital Marketing','User Interface Design']};}});
...
//
//
/* harmony default export */ var WidgetVideovue_type_script_lang_js_ = ({components:{CoolLightBox: external_vue_cool_lightbox_default.a},data(){return{items:[{src:"https://www.youtube.com/watch?v=eS9Qm4AOOBY",autoplay:true}],index:null};}});
...
//
//
/* harmony default export */ var WidgetSocialvue_type_script_lang_js_ = ({data(){return{socialList:[{iconName:"icofont-facebook",title:"Facebook",url:"#"},{iconName:"icofont-pinterest",title:"Pinterest",url:"#"},{iconName:"icofont-instagram",title:"Instagram",url:"#"}]};}});
...
//
//
/* harmony default export */ var ServiceDetailsWrappervue_type_script_lang_js_ = ({components:{ServiceCategoryWidget:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 34)),WidgetVideo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 35)),WidgetSocial:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 36))}});
...
//
//
/* harmony default export */ var service_detailsvue_type_script_lang_js_ = ({components:{Header:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 26)),OffCanvasMobileMenu:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 30)),PageTitle:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 31)),ServiceDetailsWrapper:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),ContactDevider:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 33)),Footer:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 25))},head(){return{title:'Service Details'};}});
...
/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(26).default,OffCanvasMobileMenu: __webpack_require__(30).default,PageTitle: __webpack_require__(31).default,ServiceDetailsWrapper: __webpack_require__(60).default,ContactDevider: __webpack_require__(33).default,Footer: __webpack_require__(25).default})
